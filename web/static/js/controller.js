(function(angular) {
    ...
    var mavicdroneshop = angular.module('mavicdroneshop', ['ngRoute'])

    // Share user between controllers
    mavicdroneshop.factory('currentUser', function() {
        var data = {
            uniqueid: '',
            user: {},
            cart: {
    ...
    mavicdroneshop.config(['$routeProvider', '$locationProvider', ($routeProvider, $locationProvider) => {
        $routeProvider.when('/', {
    ...
    mavicdroneshop.run(function($rootScope, $templateCache) {
    ...
    mavicdroneshop.controller('searchform', function($scope, $http, $routeParams) {
        $scope.data = {};
    ...
    mavicdroneshop.controller('productform', function($scope, $http, $routeParams, $timeout, currentUser) {
        $scope.data = {};
        $scope.data.message = ' ';
        $scope.data.product = {};
        $scope.data.rating = {};
    ...
    mavicdroneshop.controller('cartform', function($scope, $http, $location, currentUser) {
        $scope.data = {};
        $scope.data.cart = {};
    ...
    mavicdroneshop.controller('shipform', function($scope, $http, $location, currentUser) {
        $scope.data = {};
    ...
    mavicdroneshop.controller('paymentform', function($scope, $http, currentUser) {
        $scope.data = {};
        $scope.data.message = ' ';
    ...
    mavicdroneshop.controller('loginform', function($scope, $http, currentUser) {
        $scope.data = {};
        $scope.data.name = '';
        $scope.data.email = '';
        $scope.data.password = '';
